...
def create_resume():
    ...
    def add_patents_section():
        ...
        base_indent = 0.35
        patents = ["Systems and Methods for Securely Generating and Printing a Document (US11636464B2)", 
                   "Graphical User Interface for Centralized Register Device Management and Monitoring (US12613610B2)"]
